  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8">
                <Image
                  ...
                  sizes="(max-width: 640px) 20px, (max-width: 1024px) 24px, 32px"
                  quality={90}
                />
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mt-8 md:mt-16 mb-20 md:mb-32">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mt-8 md:mt-16">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
