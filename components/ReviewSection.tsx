...
export default function ReviewSection() {
  ...
  const allReviews = [
    ...
    { ...reviews[1], imageSrc: "/images/landing/image26.jpg", customerName: "최** 고객님", date: "naver review", reviewText: "체험권으로 한 번만 받아볼려했는데, 첫 관리 후 인바디에서 체지방이 눈에 띄게 줄고 근육량 올라간 거 확인하고 다회권 바로 결제 했어욬ㅋㅋ", badgeLine2: "2.1kg 감량" },
  ];
