...
export default function ReviewSection() {
  ...
  const allReviews = [
    ...
    { ...reviews[1], imageSrc: "/images/landing/image25.jpg", customerName: "최** 고객님", date: "naver review", reviewText: "체험권으로 한 번만 받아볼려했는데, 첫 관리 후 인바디에서 체지방이 눈에 띄게 줄고 근육량 올라간 거 확인하고 다회권 바로 결제 했어욬ㅋㅋ", badgeLine2: "2.1kg 감량" },
  ];
    ...
    >
      <div className="container mx-auto max-w-[95%] lg:max-w-[90%] px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div>
            <p
              className="text-lg md:text-xl lg:text-2xl xl:text-3xl leading-[1.2] md:[line-height:120%]"
              style={largeTextBold}
            >
              도안재 경험 고객분들의
            </p>
