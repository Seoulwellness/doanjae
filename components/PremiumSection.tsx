...
export default function PremiumSection() {
  // Video code commented out - video file is too large for git
  // TODO: Use video hosting service (YouTube/Vimeo) or compress video file
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <div className="relative w-full aspect-video overflow-hidden rounded-none">
            {/* Video code commented out - using image instead */}
            {/* TODO: Replace with video hosting service or compressed video */}
            {/* {showPoster && (
            ...
            {/* Image placeholder - replace with video when ready */}
            <Image
              src="/images/landing/video.png"
              alt="프리미엄 다이어트 테라피"
              fill
